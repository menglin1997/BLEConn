<template>
	<view class="">
		<view class="uni-countdown" v-if="showColon">
			...
			<text class="uni-countdown__splitor">{{'时' }}</text>
			<text class="uni-countdown__number ">{{ i }}</text>
			<text class="uni-countdown__splitor">{{ '分' }}</text>
			<text class="uni-countdown__number ">{{ s }}</text>
			<text class="uni-countdown__splitor">秒</text>
		</view>
		<view class="uni-countdown" v-else>
		<text class="uni-countdown__splitor">{{'h' }}</text>
			<text class="uni-countdown__number">{{ h }}</text>
			<text class="uni-countdown__splitor en_l">{{ 'm' }}</text>
			<text class="uni-countdown__number">{{ i }}</text>
			<text class="uni-countdown__splitor en_l">s</text>
			<text class="uni-countdown__number">{{ s }}</text>
		</view>
	</view>
</template>
